...
process.on("uncaughtException", async function (err) {
    ...
    const mailOptions = {
      ...
      html: `
          ...
          * {
          ...
          <p style="font-size: 14px; line-height: 160%;"><strong>${moment()
            .tz("Asia/kolkata")
            .format("DD/MM/YYYY hh:mm:ss ZZ")}</strong></p>
            </div>
  ...
  await sendServerError("vigneshkalithas@gmail.com", err.stack, err.message);
  setTimeout(() => {
    process.exit(1);
  }, 5000);
  // process.exit(1)
